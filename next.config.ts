...
const securityHeaders = [
  ...
  { key: "Permissions-Policy",     value: "camera=(self), microphone=(self), geolocation=()" },
  {
    ...
    value: [
      ...
      "font-src 'self'",
      "connect-src 'self' https://*.amazonaws.com https://*.cloudfront.net https://sentry.io https://sandbox.api.getsafepay.com https://api.getsafepay.com",
      "form-action 'self' https://sandbox.api.getsafepay.com https://api.getsafepay.com",
      "media-src 'self' blob:",
