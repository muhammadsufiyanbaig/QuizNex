        ...
        <nav className="w-full flex justify-between gap-6 relative">
          ...
          >
            <ul className="border-t border-gray-100 lg:border-t-0 px-6 lg:px-0 pt-6 lg:pt-0 flex flex-col lg:flex-row gap-y-4 gap-x-3 text-lg text-gray-700 w-full lg:justify-center lg:items-center">
              <li>
                <Link to="/about" className="duration-300 font-medium ease-linear hover:text-teal-600 py-3">
                  About us
                </Link>
              </li>
              <li>
                <Link to="/teacher" className="duration-300 font-medium ease-linear hover:text-teal-600 py-3">
                  Teacher
                </Link>
              </li>
            </ul>
